...
class _ButtonsState extends State<Buttons> {
    ...
    return Row(
      ...
      children: [
        ...
        Button(
          onPressed: () {
            Share.share(
              "I've just reported an environmental issue via MEP app here is the probleme scene: https://www.google.com/maps/search/?api=1&query=${widget.report.latitude.toString()},${widget.report.longitude.toString()}",
            );
          },
  ...
  Future<void> _openmap(String Latitude, String Longtitude) async {
...
class Button extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(backgroundColor: ColorConstant.backgroundColor),
      onPressed: onPressed,
      child: Center(
          child: Icon(
            color: Colors.black,
